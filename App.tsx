...
const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const placeOrder = useCallback(async (orderDetails: { shippingAddress: ShippingAddress, paymentMethod: string }) => {
    ...
    const shippingAddressString = `${orderDetails.shippingAddress.address}, ${orderDetails.shippingAddress.city}, ${orderDetails.shippingAddress.country || ''} ${orderDetails.shippingAddress.postalCode || ''}`.trim();
